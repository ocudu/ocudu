...
const dl_msg_alloc* ocudu::find_ue_pdsch_with_lcid(rnti_t rnti, lcid_dl_sch_t lcid, span<const dl_msg_alloc> dlgrants)
{
...
const dl_msg_alloc* ocudu::find_ue_pdsch_with_lcid(rnti_t rnti, lcid_t lcid, span<const dl_msg_alloc> dlgrants)
{
  return find_ue_pdsch_with_lcid(rnti, lcid_dl_sch_t{lcid}, dlgrants);
}

const csi_report_configuration* ocudu::find_ue_uci_with_csi(rnti_t rnti, const ul_sched_result& ul_res)
{
