...
du_manager_test_bench::du_manager_test_bench(span<const du_cell_config> cells) :
  ...
  drb_rx_seg_pool(make_rlc_drb_rx_window_seg_pool(rlc_drb_rx_window_seg_pool_size)),
  drb_tx_seg_pool(make_rlc_drb_tx_window_seg_pool(rlc_drb_tx_window_seg_pool_size)),
  srb_rx_seg_pool(make_rlc_srb_rx_window_seg_pool(rlc_srb_rx_window_seg_pool_size)),
  srb_tx_seg_pool(make_rlc_srb_tx_window_seg_pool(rlc_srb_tx_window_seg_pool_size)),
  params{{"ocudu", (gnb_du_id_t)1, 1, du_cells},
         ...
         {mac,
          ...
          rlc_pcap,
          nullptr,
          drb_rx_seg_pool->get_pool_of_type<rlc_rx_am_sdu_info>(),
          drb_tx_seg_pool->get_pool_of_type<rlc_tx_am_sdu_info>(),
          drb_rx_seg_pool->get_pool_of_type<rlc_rx_um_sdu_info>(),
          srb_rx_seg_pool->get_pool_of_type<rlc_rx_am_sdu_info>(),
          srb_tx_seg_pool->get_pool_of_type<rlc_tx_am_sdu_info>()},
         {mac}},
  cell_mng(params),
