...
{
  ASSERT_TRUE(expected_dmrs.dmrs_symb_pos == dmrs_under_test.dmrs_symb_pos);
  ASSERT_EQ(fmt::underlying(expected_dmrs.config_type), fmt::underlying(dmrs_under_test.config_type));
  ASSERT_EQ(expected_dmrs.dmrs_scrambling_id, dmrs_under_test.dmrs_scrambling_id);
  ASSERT_EQ(expected_dmrs.low_papr_dmrs, dmrs_under_test.low_papr_dmrs);
  ASSERT_EQ(expected_dmrs.n_scid, dmrs_under_test.n_scid);
  ASSERT_EQ(expected_dmrs.num_dmrs_cdm_grps_no_data, dmrs_under_test.num_dmrs_cdm_grps_no_data);
  ASSERT_TRUE(expected_dmrs.dmrs_ports == dmrs_under_test.dmrs_ports);
}
