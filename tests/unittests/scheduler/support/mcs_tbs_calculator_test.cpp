...
{
  sched_bwp_config     active_bwp_cfg = ue_cell_cfg.init_bwp();
  ...
  active_bwp_cfg.ul          = sched_bwp_ul_config{active_bwp_cfg.ul.common(),
                                          std::move(bwp_ded),
                                          std::nullopt,
                                          active_bwp_cfg.ul.pusch_td_mapper(),
                                          active_bwp_cfg.ul.pucch_td_mapper()};
